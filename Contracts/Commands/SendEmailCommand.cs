#region Copyright
//------------------------------------------------------------------------------------------
// <copyright file="SendEmailCommand.cs" company="United Shore Financial Services LLC.">
...
{
    /// <summary>
    /// Class for sending email Command
    /// </summary>
    public class SendEmailCommand : DefaultCommand
    {
